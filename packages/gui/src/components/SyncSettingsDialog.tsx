...
export function SyncSettingsDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative bg-bg-secondary border border-border rounded-lg shadow-2xl w-full max-w-2xl h-[85vh] flex flex-col overflow-hidden animate-fade-in">
        {/* Header */}
        ...
        {/* Footer */}
        <div className="flex-shrink-0 flex items-center justify-end gap-2 p-4 border-t border-border bg-bg-tertiary">
